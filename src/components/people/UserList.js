...
const UserList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: () => (
        <>
          <a className="me-3" onClick={handleEditUserModal}>
  ...
  return (
    <>
        ...
        <div className="content">
          <div className="page-header">
            ...
            <div className="page-btn">
              <a className="btn btn-added" onClick={handleAddUserModal}>
      ...
      <Modal show={addUserModal} onHide={handleAddUserModal} size="xl">
        <Modal.Body>
          <AddUser customSpace="m-0 p-0" />
        </Modal.Body>
      </Modal>
      <Modal show={editUserModal} onHide={handleEditUserModal} size="xl">
        <Modal.Body>
          <EditUser customSpace="m-0 p-0" />
        </Modal.Body>
      </Modal>
    </>
  );
