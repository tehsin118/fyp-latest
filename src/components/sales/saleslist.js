...
const SalesList = (props) => {
        ...
        <>
          <div className="text-center">
            ...
            <ul className="dropdown-menu">
              <li onClick={handleSaleDetailModal}>
  ...
  const handleSaleDetailModal = () => setSaleDetailModal(!saleDetailModal);
  ...
  return (
    <>
      ...
      <Modal show={saleDetailModal} onHide={handleSaleDetailModal} size="xl">
        <Modal.Body>
          <SalesDetail customSpace="m-0 p-0" />
        </Modal.Body>
      </Modal>
    </>
  );
